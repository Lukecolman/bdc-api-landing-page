    ...
    items: [
      {
        id: 1,
        icon: '',
        content: "Obtené información en tiempo real y detallada de todas tus operaciones."
      },
      {
        id: 2,
        icon: '',
        content: "Acelerá el proceso de recaudación realizando transacciones instantáneamente."
      },
      {
        id: 3,
        icon: '',
        content: "Identificá cada operación por cliente, producto o servicio, facilitando tu conciliación bancaria."
      },
      {
        id: 4,
        icon: '',
        content: "Garantizá transacciones seguras tanto para tu empresa como para tus clientes."
      },
      {
        id: 5,
        icon: '',
        content: "Soluciones que permiten un control total y la captura precisa de datos."
      },
      {
        id: 6,
        icon: '',
        content: "Cumplimiento normativo y seguridad garantizados en todas las operaciones."
      }
    ]
  };
   ...
   title: "¿Cómo es el proceso para integrar BDC Conecta?",
    items: [
      ...
      },
      {
        id: 3,
        icon: '',
        content: "Te ayudamos a integrar las APIs a tus procesos en conjunto con tu equipo."
      },
      {
        id: 4,
        icon: '',
...
export const solutions = [
    {
      sectionTitle: "Soluciones de BDC Conecta",
      items: [
        {
          id: 1,
          image: '',
          title: "Cobranzas y Pagos",
          content: "Automatizá los pagos y cobros de tus clientes y proveedores, ahorrando tiempo y costos de gestión. Con BDC Conecta podés consultar y realizar transferencias a CBU, CVU y Alias, y gestionar proveedores de forma eficiente. Transforma la gestión de tus transacciones y llevá tu negocio al próximo nivel con nuestras soluciones tecnológicas."
        },
        {
          id: 2,
          image: '',
          title: "Billetera Virtual",
          content: "Nuestra solución ofrece diversas funcionalidades para optimizar la gestión de las transacciones en tu billetera: altas y cambio de alias de CVU, consulta, envío y recepción de transferencias entre CVU/CBU, y notificaciones de crédito en CVU, y posibilidad de financiación a tus clientes."
        },
        {
          id: 3,
          image: '',
          title: "Información de la cuenta",
          content: "Te permite gestionar integralmente las cuentas de tus clientes en BDC Conecta. Accedé a los movimientos de cuenta, consultá datos mediante alias, CBU o CVU, y validá la información asociada a cada uno. Identificá el origen de transferencias recibidas y obtené el saldo y el detalle de cada cuenta de manera sencilla y eficiente."
        }
      ]
    }
  ];
...
export const bdcApplicants = [
    {
      ...
      subtitle: "Nuestro universo de BDC Conecta nos permite ir directo a la resolución o mejora de tus procesos específicos, como ya lo hicimos con:",
      item1: [
        {
          id: 1,
          icon: '',
          title: "PSP",
          content: "Nuestro universo de BDC Conecta nos permite ir directo a la resolución o mejora de tus procesos específicos, como ya lo hicimos con:",
        },
      ],
      item2: [
        {
          id: 2,
          icon: '',
          title: "Colegios, gimnasios y clubes",
          content: "Realizan cobros de tarjeta crédito y débito, pago masivo a proveedores automatizando procesos y reduciendo recursos, garantizando la optimización de tesorería.",
        },
      ],
      item3: [
        {
          ...
          icon: '',
          title: "Salud",
          content: "Nuestro cliente puede realizar pagos masivos y programados a toda su nómina y proveedores, facilitando su gestión interna y externa. Recauda de manera ágil sus cuotas mensuales e identifica de manera precisa toda la información de las cuentas de sus asociados y proveedores.",
        },
      ],
      item4: [
        {

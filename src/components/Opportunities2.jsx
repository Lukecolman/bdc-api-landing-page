            ...
            <div className='grid gap-4 row-gap-5 sm:grid-cols-2 lg:grid-cols-4'>
                <div className='flex flex-col justify-between p-5 border rounded shadow-sm'>
                    <div>
                        ...
                        <p className='mb-3 text-sm text-gray-900'>{opportunities.items[0].content}</p>
                    </div>
                </div>
                <div className='flex flex-col justify-between p-5 border rounded shadow-sm'>
                    <div>
                        ...
                        <p className='mb-3 text-sm text-gray-900'>{opportunities.items[1].content}</p>
                    </div>
                </div>
                <div className='flex flex-col justify-between p-5 border rounded shadow-sm'>
                    <div>
                        ...
                        <p className='mb-3 text-sm text-gray-900'>{opportunities.items[2].content}</p>
                    </div>
                </div>
                <div className='flex flex-col justify-between p-5 border rounded shadow-sm'>
                    <div>
                        ...
                        <p className='mb-3 text-sm text-gray-900'>{opportunities.items[3].content}</p>
                    </div>
                </div>
            </div>
